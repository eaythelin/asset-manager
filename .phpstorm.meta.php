...
'filepond.disk','filepond.temp_disk','filepond.temp_folder','filepond.middleware','filepond.soft_delete',
'filepond.expiration','filepond.controller','filepond.model','filepond.validation_rules','filepond.server.url',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\xampp\\htdocs\\asset-manager\\public\\storage','logging.default','logging.deprecations.channel',
...
'blade-heroicons.class','blade-heroicons.attributes','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'dashboard.index','subcategorycount.get','dashboard.chartData','assets.index','assets.create',
'assets.store','assets.edit','assets.update','assets.show','assets.subcategories.get',
'assets.dispose','requests.index','requests.create','requests.store','requests.subcategories.get',
'workorders.index','employees.index','employees.show','employees.store','employees.update',
'employees.delete','department.index','departments.store','departments.update','departments.delete',
'category.index','category.store','category.update','category.delete','subcategory.index',
'subcategory.store','subcategory.update','subcategory.delete','suppliers.index','suppliers.store',
'suppliers.update','suppliers.delete','users.index','users.store','users.update',
'users.toggle','users.restore','users.soft-delete','users.force-delete','logoutUser',
'placeholder','login','loginUser','password.request','password.email',
'password.reset','password.update','storage.local',);
        registerArgumentsSet('views', 
'auth.forgotpassword','auth.login','auth.resetpassword','components.auth-card','components.back-link',
'components.buttons','components.dashboard-cards','components.dropdown-navs','components.label','components.modal',
'components.modal-input-box','components.modal-text-area-box','components.navlinks','components.page-input','components.page-label',
'components.page-select','components.page-textarea','components.pages-header','components.search-bar','components.session-error',
'components.tables','components.td','components.toast-success','components.validation-error','layouts.authlayout',
'layouts.pageslayout','modals.assets-modals.dispose-asset-modal','modals.category-modals.create-category-modal','modals.category-modals.delete-category-modal','modals.category-modals.edit-category-modal',
'modals.department-modals.create-department-modal','modals.department-modals.delete-department-modal','modals.department-modals.edit-department-modal','modals.employee-modals.create-employee-modal','modals.employee-modals.delete-employee-modal',
'modals.employee-modals.edit-employee-modal','modals.subcategory-modals.create-subcategory-modal','modals.subcategory-modals.delete-subcategory-modal','modals.subcategory-modals.edit-subcategory-modal','modals.supplier-modals.create-supplier-modal',
...
'modals.user-modals.permanent-delete-user','modals.user-modals.reactivate-user-modal','pages.assets.create-asset','pages.assets.edit-asset','pages.assets.index-assets',
'pages.assets.show-asset','pages.categories','pages.dashboard','pages.departments','pages.employees.index-employees',
'pages.employees.show-employee','pages.placeholder','pages.requests.create-request','pages.requests.index-requests','pages.subcategories',
'pages.suppliers','pages.users','pages.workorders.index-workorders','pagination::simple-bootstrap-4','pagination::simple-tailwind',
'pagination::tailwind','partials.pages-navbar','partials.pages-sidebar','vendor.pagination.simple-bootstrap-4','vendor.pagination.simple-tailwind',
'vendor.pagination.tailwind','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line','laravel-exceptions-renderer::components.formatted-source',
