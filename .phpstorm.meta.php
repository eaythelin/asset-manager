    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'filepond' => \RahulHaque\Filepond\Filepond::class,
    ...
    override(\config(), map([
            ...
            'filepond.disk' => 'string',
            'filepond.temp_disk' => 'string',
            'filepond.temp_folder' => 'string',
            'filepond.middleware' => 'array',
            'filepond.soft_delete' => 'boolean',
            'filepond.expiration' => 'integer',
            'filepond.controller' => 'string',
            'filepond.model' => 'string',
            'filepond.validation_rules' => 'array',
            'filepond.server.url' => 'string',
            ...
            'filesystems.links.C:\xampp\htdocs\asset-manager\public\storage' => 'string',
...
'auth.passwords.users.expire','auth.passwords.users.throttle','auth.password_timeout','blade-icons.sets','blade-icons.class',
...
'excel.temporary_files.force_resync_remote','filepond.disk','filepond.temp_disk','filepond.temp_folder','filepond.middleware',
'filepond.soft_delete','filepond.expiration','filepond.controller','filepond.model','filepond.validation_rules',
'filepond.server.url','filesystems.default','filesystems.disks.local.driver','filesystems.disks.local.root','filesystems.disks.local.serve',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\xampp\\htdocs\\asset-manager\\public\\storage','logging.default',
...
'blade-heroicons.prefix','blade-heroicons.fallback','blade-heroicons.class','blade-heroicons.attributes','ide-helper.filename',
...
'signed','throttle','verified','check.permission',);
        registerArgumentsSet('routes', 
'filepond-process','filepond-patch','filepond-head','filepond-revert',
'dashboard.index','subcategorycount.get','dashboard.chartData','assets.index','assets.template',
'assets.import','assets.create','assets.store','assets.edit','assets.update',
'assets.show','assets.subcategories.get','assets.dispose','requests.index','requests.create',
'requests.store','requests.submit','requests.cancel','requests.edit','requests.update',
'requests.show','requests.subcategories.get','requests.attachments','requests.approve','requests.decline',
'workorders.index','workorders.view','workorders.edit','workorders.update','workorders.start',
'workorders.complete','workorders.cancel','employees.index','employees.show','employees.store',
'employees.update','employees.restore','employees.delete','reports.index','reports.generate',
'report.download','report.delete','department.index','departments.store','departments.update',
'departments.delete','category.index','category.store','category.update','category.delete',
'subcategory.index','subcategory.store','subcategory.update','subcategory.delete','suppliers.index',
'suppliers.store','suppliers.update','suppliers.delete','users.index','users.store',
'users.update','users.toggle','users.restore','users.soft-delete','users.force-delete',
'logoutUser','placeholder','login','loginUser','password.request',
'password.email','password.reset','password.update','storage.local',);
        registerArgumentsSet('views', 
'auth.forgotpassword','auth.login','auth.resetpassword','components.auth-card','components.back-link',
'components.buttons','components.dashboard-cards','components.detail-item','components.dropdown-navs','components.import-error-validation',
'components.label','components.modal','components.modal-input-box','components.modal-text-area-box','components.navlinks',
'components.page-create-submit-button','components.page-date-input','components.page-edit-submit-button','components.page-input','components.page-label',
'components.page-section-header','components.page-select','components.page-textarea','components.pages-header','components.request-asset-select',
'components.request-disposal-input','components.search-bar','components.session-error','components.tables','components.td',
'components.toast-success','components.validation-error','components.view-page-header-card','components.workorders.description-field','components.workorders.quantity-field',
'components.workorders.supplier-field','layouts.authlayout','layouts.pageslayout','layouts.reportlayout','modals.assets-modals.dispose-asset-modal',
'modals.assets-modals.import-asset-modal','modals.category-modals.create-category-modal','modals.category-modals.delete-category-modal','modals.category-modals.edit-category-modal','modals.department-modals.create-department-modal',
'modals.department-modals.delete-department-modal','modals.department-modals.edit-department-modal','modals.employee-modals.archive-employee-modal','modals.employee-modals.create-employee-modal','modals.employee-modals.edit-employee-modal',
'modals.reports-modals.delete-report-modal','modals.reports-modals.generate-report-modal','modals.requests-modals.approve-request-modal','modals.requests-modals.cancel-request-modal','modals.requests-modals.decline-request-modal',
'modals.requests-modals.submit-request-modal','modals.subcategory-modals.create-subcategory-modal','modals.subcategory-modals.delete-subcategory-modal','modals.subcategory-modals.edit-subcategory-modal','modals.supplier-modals.create-supplier-modal',
'modals.supplier-modals.delete-supplier-modal','modals.supplier-modals.edit-supplier-modal','modals.user-modals.create-user-modal','modals.user-modals.delete-user-modal','modals.user-modals.edit-user-modal',
'modals.user-modals.permanent-delete-user','modals.user-modals.reactivate-user-modal','modals.workorder-modals.cancel-workorder-modal','modals.workorder-modals.complete-workorder-modal','modals.workorder-modals.start-workrorder-modal',
'pages.assets.create-asset','pages.assets.edit-asset','pages.assets.index-assets','pages.assets.show-asset','pages.categories',
'pages.dashboard','pages.departments','pages.employees.index-employees','pages.employees.show-employee','pages.placeholder',
'pages.reports','pages.requests.create-request','pages.requests.edit-request','pages.requests.index-requests','pages.requests.show-request',
'pages.subcategories','pages.suppliers','pages.users','pages.workorders.edit-workorder','pages.workorders.index-workorders',
'pages.workorders.show-workorder','pagination::simple-bootstrap-4','pagination::simple-tailwind','pagination::tailwind','partials.pages-navbar',
'partials.pages-sidebar','reports.asset-report','reports.depreciation-report','reports.disposal-report','reports.requisition-report',
'reports.service-report','reports.test','vendor.pagination.simple-bootstrap-4','vendor.pagination.simple-tailwind','vendor.pagination.tailwind',
...
'C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'C:.xampp.htdocs.asset-manager.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
