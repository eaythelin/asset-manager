  ...
  <form method="POST" action="{{ route('workorders.update', $workorder->id) }}">
    ...
    <div class="bg-white p-4 rounded-2xl shadow-2xl mt-4">
      ...
      <div class = "flex flex-col sm:flex-row gap-6">
        <div class = "flex flex-col flex-1 gap-4">
          <div class="form-row">
            ...
            <x-page-input name="started_at" id="started_at" value="{{ $workorder->started_at?->format('M d, Y h:i A') }}" disabled/>
          </div>
        </div>
        ...
        <div class = "flex flex-col flex-1 gap-4">
          <div class="form-row">
            ...
            <x-page-input name="finished_at" id="finished_at" value="{{ $workorder->finished_at?->format('M d, Y h:i A') }}" disabled/>
          </div>
        </div>
      </div>
      ...
      <div class="form-row mt-5">
        ...
        <textarea name="accomplishment_details" id="accomplishment_details" class="textarea w-full md:mx-10 border-2 border-gray-400">{{ $workorder->accomplishment_details }}</textarea>
      </div>
